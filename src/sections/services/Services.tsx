  ...
  return (
    <section id="services" className="py-24 md:py-40 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-6 md:gap-8">
          {SERVICES.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 sm:p-8 bg-[#F8FAFC] border border-royal/10 hover:border-royal/30 rounded-2xl group hover:bg-white hover:shadow-xl transition-all duration-500 flex flex-col justify-between h-full shadow-sm"
              >
